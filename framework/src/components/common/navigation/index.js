            ...
            <Nav grow collapsible className="navbar__menu">
                ...
                >
                    <DropdownItem eventKey="1">
                        <i className="fa fa-motorcycle"></i> Sports
                    </DropdownItem>
                    <DropdownItem eventKey="2">
                        <i className="fa fa-home"></i>Entertainment
                    </DropdownItem>
                    <DropdownItem eventKey="3">
                        <i className="fa fa-btc"></i>Economics
                    </DropdownItem>
                    <DropdownItem eventKey="4">
                        <i className="fa fa-laptop"></i>Technology
                    </DropdownItem>
                </DropdownButton>
                <a href="#foo" className="navbar__menu__item">
          Editorial
                </a>
                <a href="#foo" className="navbar__menu__item">
          Contact Us
